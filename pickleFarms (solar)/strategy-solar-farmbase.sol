...
abstract contract StrategySolarFarmBase is StrategyBase {
  ...
  address public constant solarChef = 0xf03b75831397D4695a6b9dDdEEA0E578faa30907;
  ...
  constructor(
    ...
    function harvest() public override onlyBenevolent {
      ...
      if (_solar > 0) {
        ...
        uint256 toToken1 = _solar.sub(toToken);
      ...
      if (_token0 > 0 && _token1 > 0) {
        ...
        IERC20(tokne1).safeApprove(sushiRouter, 0);
      ...
      _distributePerformanceFeedsAndDeposit();
    }
}